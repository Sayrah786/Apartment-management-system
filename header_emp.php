  ...
  <nav class="navbar navbar-static-top" role="navigation">
    ...
    <div class="navbar-custom-menu">
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown user user-menu"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <i class="fa fa-user fa-lg"></i> <span class="hidden-xs"><?php echo $_SESSION['objLogin']['e_name']; ?></span> </a>
          <ul class="dropdown-menu">
            <!-- User image -->
...
<aside class="main-sidebar">
  ...
  <section class="sidebar" style="margin-top:10px;">
    ...
    <ul class="sidebar-menu">
      <li class="<?php if($page_name != '' && $page_name == 'e_dashboard'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>e_dashboard.php"><i class="fa fa-dashboard"></i> <span><?php echo $_data['menu_dashboard'];?></span></a> </li>
       <li class="<?php if($page_name != '' && $page_name == 'salary_details'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>e_dashboard/salary_details.php"><i class="fa fa fa-money"></i><span><?php echo $_data['salary_statement'];?></span></a></li>
       <li class="<?php if($page_name != '' && $page_name == 'e_report'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>e_dashboard/e_report.php"><i class="fa fa fa fa-bar-chart-o"></i><span><?php echo $_data['salary_report'];?></span></a></li>
       <li class="<?php if($page_name != '' && $page_name == 'rented_details'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>e_dashboard/rented_details.php"><i class="fa fa fa-user"></i><span><?php echo $_data['rented_details'];?></span></a></li>
       <li class="<?php if($page_name != '' && $page_name == 'member_details'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>e_dashboard/member_details.php"><i class="fa fa fa-user"></i><span><?php echo $_data['member_details'];?></span></a></li>
    </ul>
  </section>
  <!-- /.sidebar -->
</aside>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <h4 align="center"><?php echo $desig;?>
          </h4>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="txtProfilePassword" name="txtProfilePassword" value="<?php echo $_SESSION['objLogin']['e_password']; ?>">
          </div>
