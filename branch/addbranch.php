        ...
        <div class="box-body">
		  ...
		  <div class="form-group">
            <label for="radioStatus"><?php echo $_data['text_8'];?> :</label>&nbsp;&nbsp;
                    <input class="minimal" type="radio"  name="radioStatus" id="radioStatus" <?php if($b_status == 'enable'){echo 'checked=checked';}?> value="enable" />&nbsp;&nbsp;<span><?php echo $_data['text_9'];?></span>&nbsp;&nbsp;
                    <input class="minimal" type="radio"  name="radioStatus" id="radioStatus" <?php if($b_status == 'disable'){echo 'checked=checked';}?>  value="disable" />&nbsp;&nbsp;<span><?php echo $_data['text_10'];?></span>
          </div>
