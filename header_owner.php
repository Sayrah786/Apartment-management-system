...
<header class="main-header">
  ...
  <span class="logo-lg"><b>SAYRAH</b> Apartment Management System</span> </a>
  ...
  <nav class="navbar navbar-static-top" role="navigation">
    ...
    <div class="navbar-custom-menu">
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown user user-menu"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <i class="fa fa-user fa-lg"></i> <span class="hidden-xs">
          ...
          <ul class="dropdown-menu">
            ...
            <li class="user-header"> <img src="<?php echo $image; ?>" class="img-circle" alt="User Image" />
              <p>
                <?php echo $_SESSION['objLogin']['o_name']; ?>
                <small>
                <?php if($_SESSION['login_type'] == '1'){echo 'Admin';} else if($_SESSION['login_type'] == '2'){echo 'Owner';}?>
...
<aside class="main-sidebar">
  ...
  <section class="sidebar" style="margin-top:10px;">
    ...
    <ul class="sidebar-menu">
      <li class="<?php if($page_name != '' && $page_name == 'o_dashboard'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>o_dashboard.php"><i class="fa fa-dashboard"></i> <span><?php echo $_data['text_1']; ?></span></a> </li>
       <li class="<?php if($page_name != '' && $page_name == 'unitdetails'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>o_dashboard/unitdetails.php"><i class="fa fa-hdd-o"></i><span><?php echo $_data['text_2']; ?></span></a></li>
       <li class="<?php if($page_name != '' && $page_name == 'tenantdetails'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>o_dashboard/tenantdetails.php"><i class="fa fa-user"></i><span><?php echo $_data['text_3']; ?></span></a></li>
	  ...
	  <li class="<?php if($page_name != '' && $page_name == 'fairdetails'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>o_dashboard/fairdetails.php"><i class="fa fa-credit-card"></i><span><?php echo $_data['text_5']; ?></span></a></li>
	  <li class="<?php if($page_name != '' && $page_name == 'owner_utility_details'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>o_dashboard/owner_utility_details.php"><i class="fa fa-credit-card"></i><span><?php echo $_data['text_6']; ?></span></a></li>
	  <li class="<?php if($page_name != '' && $page_name == 'maintenance_cost'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>o_dashboard/maintenance_cost.php"><i class="fa fa-wrench"></i><span><?php echo $_data['text_7']; ?></span></a></li>
	   <li class="<?php if($page_name != '' && $page_name == 'fund_list'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>o_dashboard/fund_list.php"><i class="fa fa fa-money"></i><span><?php echo $_data['text_8']; ?></span></a></li>
       <li class="<?php if($page_name != '' && $page_name == 'rented_report'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>o_dashboard/rented_report.php"><i class="fa fa fa-credit-card"></i><span><?php echo $_data['text_9']; ?></span></a></li>
    </ul>
  </section>
  <!-- /.sidebar -->
</aside>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <h4 align="center"><?php if($_SESSION['login_type'] == '1'){echo 'Admin';} else if($_SESSION['login_type'] == '2'){echo 'Owner';}?></h4>
