      ...
      <form onSubmit="return validateMe();" action="<?php echo $form_url; ?>" method="post" enctype="multipart/form-data">
        <div class="box-body">
          ...
          <div class="form-group">
            ...
            <input type="text" name="txtOwnerEmail" value="<?php echo $o_email;?>" id="txtOwnerEmail" class="form-control" />
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div style="height:100px;border:solid 1px #ccc;overflow:auto">
              <?php 
				  	$result_unit = mysqli_query($link,"SELECT *,f.floor_no as fl_floor FROM tbl_add_unit u inner join tbl_add_floor f on u.floor_no = f.fid order by u.unit_no ASC");
					while($row_unit = mysqli_fetch_array($result_unit)){?>
              <div style="margin-left:.7%;">
                ...
                <?php echo $row_unit['unit_no']; ?>&nbsp;<?php echo '('.$row_unit['fl_floor'].')'; ?> </label>
              </div>
              <?php } ?>
            </div>
          </div>
