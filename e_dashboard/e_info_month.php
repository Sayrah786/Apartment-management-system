...
<head>
<meta charset="UTF-8">
<title>Tam Apartment Management System</title>
        ...
        <div class="box box-info">
          ...
          <div class="box-body">
        	...
        	<?php
				...
				die();*/
				$result = mysqli_query($link,"Select *,m.month_name from tbl_add_employee_salary_setup es inner join tbl_add_month_setup m on m.m_id = es.month_id where es.emp_name = '". (int)$_SESSION['objLogin']['eid'] . "' and es.month_id='".$_GET['mid']."' order by es.emp_id desc");
...
<!-- /.row -->
<div align="center"><a class="btn btn-primary btn_save" onClick="javascript:printContent('printable','Salary Report');" href="javascript:void(0);"><?php echo $_data['text_6'];?></a></div>
</body>
</html>
