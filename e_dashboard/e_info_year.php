        ...
        <div class="box box-info">
          ...
          <div class="box-body">
        	...
        	<?php
				...
				die();*/
				$result = mysqli_query($link,"Select *,m.month_name from tbl_add_employee_salary_setup es inner join tbl_add_month_setup m on m.m_id = es.month_id where es.emp_name = '". (int)$_SESSION['objLogin']['eid'] . "' and es.xyear='".$_GET['yid']."' order by es.emp_id desc");
