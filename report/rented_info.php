        ...
        <div class="box box-info">
          ...
          <div class="box-body">
            <table style="font-size:13px;" class="table sakotable table-bordered table-striped dt-responsive">
              ...
              <tbody>
            <?php
			$result = mysqli_query($link,"Select *,f.floor_no as ffloor,u.unit_no from tbl_add_rent r inner join tbl_add_floor f on f.fid = r.r_floor_no inner join tbl_add_unit u on u.uid = r.r_unit_no where r.r_status='".$_GET['rsid']."' and r.branch_id = '" . (int)$_SESSION['objLogin']['branch_id'] . "'");
